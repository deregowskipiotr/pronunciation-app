          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-end">
              <motion.button
                ...
                className="flex items-center gap-3 md:gap-2 px-3 md:px-5 py-2 md:mr-0.5 bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700/50 rounded-md shadow-md text-slate-400 hover:text-slate-300 transition-colors cursor-pointer"
              >
