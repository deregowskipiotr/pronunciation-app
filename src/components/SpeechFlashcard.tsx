...
export const SpeechFlashcard = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full gap-4 p-2 md:p-4 border border-slate-700/50 rounded-md bg-slate-900/50 backdrop-blur-sm shadow-lg">
        ...
        <div className="lg:w-1/2 flex flex-col justify-between min-h-100 md:min-h-120 bg-slate-800/20 rounded-md p-4 md:p-6 border border-slate-700/50">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center w-full gap-2 md:gap-3">
              ...
              {/* Reset Button - exactly same structure */}
              <div className="flex-1 min-w-0">
                <motion.button
            ...
            <div className="grid grid-cols-3 gap-2 md:gap-3">
              <div className="bg-slate-800/50 p-2 md:p-3 rounded-md border border-slate-700/50 text-center">
                ...
                <div className="text-lg md:text-xl font-bold text-blue-500/50">
                  {accuracy}%
                </div>
              </div>
              <div className="bg-slate-800/50 p-2 md:p-3 rounded-md border border-slate-700/50 text-center">
            ...
            <div className="space-y-1.5">
              ...
              <div className="w-full bg-slate-800/50 rounded-full h-2 md:h-2.5 border border-slate-700/50 overflow-hidden">
                <div
      ...
      <div className="w-full mt-1 md:mt-2 space-y-3 md:space-y-4">
        {/* Feedback Message */}
        <AnimatePresence>
          {showFeedback && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className={`p-3 md:p-4 mx-1 md:mx-2 rounded-md ${
                isFeedbackPositive
            ...
            >
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-slate-400 text-[11px] md:text-sm truncate">
                    Target:{" "}
        ...
        {stt.state.transcript && !showFeedback && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="p-3 md:p-4 bg-slate-800/30 border border-slate-700/50 rounded-md text-center"
          >
        ...
        {stt.state.error && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="p-3 md:p-4 bg-red-500/10 border border-red-500/30 rounded-md text-red-400 text-[11px] md:text-sm text-center"
          >
            {stt.state.error}
          </motion.div>
        )}
